...
\coorientador{\chooselang{Prof. Md. Co\hyp{}supervisor Name}{Prof. Dr. Nome do Coorientador}}
...
{
    \chooselang
    {Thesis submitted to the~\imprimirprograma~of the~\imprimirinstituicao~to obtain the Doctor's
    Degree in Electrical Engineering. \showfont}
    {Tese submetida ao~\imprimirprograma~da~\imprimirinstituicao~para a obtenção do Grau de Doutor
    em Engenharia Elétrica. \showfont}
}
