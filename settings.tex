...
\def\listofboardsname{List of Frames}
\DeclareFloatingEnvironment[fileext=loq,placement={!hbtp},name=Frame,within=chapter,listname=\listofboardsname]{board}
...
\AdjustForMemoir{board}
\newlistentry{board}{loq}{0}
