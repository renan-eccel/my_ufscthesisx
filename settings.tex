...
\@ifpackageloaded{biblatex}
{
    ...
    {
        \iflistundef{pageref}
        {\printtext{\chooselang{\autocap{n}o citation in the text}{\autocap{n}enhuma citação no texto}.}}
        {%
            \printtext
            {%
                \ifnumgreater{\value{citecounter}}{1}
                    {\chooselang{\autocap{c}ited}{\autocap{c}itado} \arabic{citecounter} \chooselang{times}{vezes}}
                    {\chooselang{\autocap{c}ited}{\autocap{c}itado} \arabic{citecounter} \chooselang{time}{vez}}
            }%
            \setunit{\addspace}%
