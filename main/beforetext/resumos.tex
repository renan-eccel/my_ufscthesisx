...
para uso, assim como os métodos usados para gerá-las.
...
Time Windows) and DARP (Dial-A-Ride Problem) do not have widely used 
...
dynamic PDPTW and DARP currently available for use, as well as the 
...
This is done in order to help reserachers choose interesting sets of 
instances to test new algorithms, or, if necessary, the choice of a method for 
generating new instances.
The analysis results show that most of the studied sets have 
