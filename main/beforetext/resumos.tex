...
Na literatura atual, o problema de coleta e entrega com janelas de tempo
(PDPTW - \textit{Pickup and Delivery Problem with Time Windows} e o problema
...
solução.
Por esse motivo, este artigo tem como propósito analisar os conjuntos de 
instâncias de problemas PDPTW e DARP dinâmicos atualmente disponíveis
para uso, assim como os métodos usados para geração destas.
...
O artigo mostra que, em sua maioria, os conjuntos estudados apresentam baixa
variabilidade em suas medidas de dinamismo e urgência, sendo essa 
característica causada principalmente pelo método utilizado para geração das
instâncias.
...
In the current literature, the dynamic PDPTW (Pickup and Delivery Problem with
...
For this reason, this article aims to analyze the sets of instances of dynamic 
PDPTW and DARP problems currently available for use, as well as the methods 
...
The article shows that, for the most part, the studied sets present low 
variability in their measures of dynamism and urgency, this characteristic is 
mainly caused by the method used to generate the instances.
