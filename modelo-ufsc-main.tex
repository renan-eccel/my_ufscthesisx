...
\@ifpackageloaded{setup/ufscthesis}
{
    ...
    \hypersetup{
        ...
        linkcolor=link_color, % color of internal links
        citecolor=dkgreen, % color of links to bibliography
