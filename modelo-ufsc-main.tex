...
% 6. `pdfTeX`
%
% Because the bibliography includes a cyclic reference to another bibliography, so we need a last
% pass to fix the bibliography undefined references:
\input{setup/setup}
