...
% Dedicatória
\addtothesispreliminarycontent{Dedicatória}
\begin{dedicatoria}
    \vspace*{\fill}
    \centering
    \noindent
...
\addtothesispreliminarycontent{Lista de Figuras}
\pdfbookmark[0]{\listfigurename}{lof}
\listoffigures*
\cleardoublepage

% inserir lista de tabelas
\addtothesispreliminarycontent{Lista de Tabelas}
\pdfbookmark[0]{\listtablename}{lot}
\listoftables*
\cleardoublepage

% inserir códigos fonte
\addtothesispreliminarycontent{Lista de Códigos Fonte}
...
\addtothesispreliminarycontent{Sumário}
\begin{KeepFromToc}
