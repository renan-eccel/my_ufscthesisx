...
\addtothesispreliminarycontent{Resumo em Português}
...
% resumo em inglês
\addtothesispreliminarycontent{English's Abstract}
\begin{otherlanguage*}{english}
\begin{resumo}[Abstract]

    This is the english abstract.

    \imprimirpalavraschave{Key-words}{latex. abntex. text editoration.}
...
% % resumo em francês
% \addtothesispreliminarycontent{Français Résumé}
% \begin{resumo}[Résumé]
...
% % resumo em espanhol
% \addtothesispreliminarycontent{Español Resumen}
